...
```
В репозитории прикреплены Python файлы для раблты с базой данных, в них описаны программы которые могут вставлять и изымать данные из базы данных и анализировать полученное по 3 гипотезам: <br />
[Python file со вставкой и получением данных](https://github.com/marat74251/BD_HW/blob/head_bd/prog_for_bd.py) <br />
[Python file с диаграммамии графикамми](https://github.com/marat74251/BD_HW/blob/head_bd/prog_for_bggraphs.py) <br />
